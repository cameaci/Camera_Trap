...
def test_prefix_added_for_windows_tensorflow_v1():
    ...
    env_dir = Path("C:/Users/x/WSP-CameraTrap/envs/env-tensorflow-v1")
...
def test_no_prefix_for_other_envs_on_windows():
    ...
    env_dir = Path("C:/Users/x/WSP-CameraTrap/envs/env-pytorch")
...
def test_no_prefix_off_windows():
    ...
    env_dir = Path("/home/x/WSP-CameraTrap/envs/env-tensorflow-v1")
