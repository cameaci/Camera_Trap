...
`wsp-cameratrap-detections.csv` and the XLSX detections sheet used to carry
...
also makes them agree with `wsp-cameratrap-files.csv` and `counts.csv` beside
them.

The complete record is `wsp-cameratrap-recognitions.json`, which keeps every
